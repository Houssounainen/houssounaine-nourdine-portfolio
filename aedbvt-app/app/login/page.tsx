  ...
  return (
    <main id="contenu" className="auth-page">
      <section className="auth-card">
        ...
        <h1>Connexion</h1>
        <p>Les candidats choisissent leur mot de passe au moment de la demande. L’accès à l’espace membre est ouvert uniquement après approbation par l’AEDBVT.</p>
