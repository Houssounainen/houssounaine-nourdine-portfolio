...
export default async function DashboardPage() {
  ...
  const quickLinks=[
    ...
    ...(staff?[["/analytics","Statistiques","Pilotage & données","Adhésions, activité et indicateurs agrégés."],["/communication","Communication","Messages ciblés","Informer tous les membres, le staff, un rôle ou un village."],["/exports","Exports","Données & archivage","CSV, Excel XML, PDF et sauvegardes selon vos droits."],["/assets","Patrimoine","Équipements & stock","Biens, affectations, maintenance et consommables."]]:[]),
