...
export async function proxy(request: NextRequest) {
  ...
  const protectedPath = ["/dashboard", "/me", "/chat", "/agenda", "/announcements", "/members", "/applications", "/organization", "/finance", "/documents", "/governance", "/operations", "/administration", "/notifications", "/requests", "/cases", "/analytics", "/communication", "/content", "/exports", "/assets", "/partners", "/search", "/admin"].some((x) => pathname===x || pathname.startsWith(x+"/"));
