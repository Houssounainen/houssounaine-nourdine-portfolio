...
export async function proxy(request: NextRequest) {
  ...
  const protectedPath = ["/dashboard", "/me", "/news", "/agenda", "/announcements", "/members", "/applications", "/organization", "/finance", "/documents", "/governance", "/operations", "/administration", "/notifications", "/requests", "/cases", "/analytics", "/communication", "/content", "/exports", "/assets", "/admin"].some((x) => pathname===x || pathname.startsWith(x+"/"));
