...
GitHub Pages héberge uniquement des fichiers statiques. Le formulaire prépare donc un e-mail dans l’application du visiteur et ne stocke aucune donnée. Une administration en ligne ou un envoi serveur nécessiterait ultérieurement un CMS ou un service externe sécurisé.

## Publication

Le site est prévu pour être publié depuis la branche `main` avec GitHub Pages.
